 ...
 */
public class TongdunApiResponse {
    ...
    private List<TongdunPolicy> policy_set        = new ArrayList<TongdunPolicy>();    // 策略集信息
    ...
    public List<TongdunPolicy> getPolicy_set() {
        return policy_set;
    }

    public void setPolicy_set(List<TongdunPolicy> policy_set) {
